...
tags: 'GitHub Pages', '搭建网站', 'FTP', 'ftp转html'
...
![添加代码仓库](/assets/images/github-new-repository.png)

### 填写仓库信息

![填写仓库信息](/assets/images/create-new-repository.png)

### 选择Clone or download > Use SSH 

![](/assets/images/choose-ssh.png)

然后复制一下url
![](/assets/images/copy-ssh-url.png)

### 找一个你认为合适的地方或者新建一个文件夹来存即将要clone下来的项目

**点击鼠标右键选中Git Bash Here 就出出现一个命令操作的窗口**

![](/assets/images/open-git.png)

![](/assets/images/git-bash-here.png)
...
![](../../assets/images/clone-git-repository.png)
...
![](/assets/images/export-html.png)

### 改变目录结构

**新建一个文件夹并且把刚刚生成的文件放到这个目录下,把 html 文件重命名为 index.html

![](/assets/images/rename-html.png)
...
![](/assets/images/open-respoitory-with-vscode.png)

*安装这个插件 JS-CSS-HTML Formatter ,这是一个格式化代码的插件*

![](/assets/images/install-html-formatter.png)
>然后打开 html 文件, 使用刚才安装的插件将代码格式化, 将代码格式化是为了更好的去进行编辑

![](/assets/images/format-html.png)
...
```
![](/assets/images/git-commit-files.png)

> 这时去我们的 GitHub 账号上看刚才新建的代码仓库，发现我们新增的文件已经提交上来了

![](/assets/images/push-file-ok.png)

### 设置 GitHub Pages

>选择Setting

![](/assets/images/choose-setting.png)

>往下滚找到 GitHub Pages 配置

![](/assets/images/setting-github-pages.png)

>设置完成就会提示我们的站点已经发布到 'https://g-c-chen.github.io/qptest/' 地址下

![](/assets/images/github-pages-url.png)
